// app/admin/returns/[rmaNumber]/page.tsx
...
export default function ReturnDetailPage({
  ...
  const getStatusColor = (status: string) => {
    const colors: Record<string, string> = {
      ...
      INSPECTION_COMPLETE: "bg-cyan-100 text-cyan-800 border-cyan-200",
      RESTOCKING: "bg-teal-100 text-teal-800 border-teal-200",
  ...
  const getConditionColor = (condition: string) => {
    const colors: Record<string, string> = {
      NEW_UNOPENED: "text-green-600",
      LIKE_NEW: "text-green-500",
      GOOD: "text-blue-600",
      FAIR: "text-yellow-600",
      POOR: "text-orange-600",
      DEFECTIVE: "text-red-600",
      DAMAGED: "text-red-700",
      EXPIRED: "text-purple-600",
    };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div>
              ...
              >
                <Button variant={"default"}>Packing Slip</Button>
              </Link>
            </div>
                  ...
                  <div key={item.id} className="p-6">
                    ...
                    <div className="grid grid-cols-4 gap-4 mb-4">
                      <div>
                        ...
                        <p className="font-medium">{item.quantityRequested}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        <p className="text-xs text-gray-500">Restockable</p>
