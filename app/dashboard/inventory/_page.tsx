...
export default function InventoryDashboard() {
  ...
  // Determine if we're filtering (has previous data) or initial loading (no data)
  ...
  // Initial loading done in loading.tsx
  ...
  return (
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-6 text-sm">
            <div className="relative flex-1">
              ...
              <Input
                ...
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)} // Only update searchTerm
        ...
        {/* Pagination Controls */}
        {totalPages > 1 && (
          <div className="flex items-center justify-between px-4 py-3 border-t dark:border-gray-700 mt-4">
            ...
            <div className="flex gap-2">
              <Button
                ...
                disabled={currentPage === 1 || isFiltering} // Changed
              >
                Previous
              </Button>
              ...
              <Button
                ...
                disabled={currentPage === totalPages || isFiltering} // Changed
              >
                Next
              </Button>
            </div>
