      ...
      <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-4">
                ...
                <div className="flex space-x-3">
                  <input
                    ...
                    autoFocus
                    className="flex-1 p-2 rounded-md border border-gray-300 dark:border-zinc-600 bg-white dark:bg-zinc-900 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-lg"
                  />
                  <button
                    type="submit"
                    disabled={loading || !rmaInput.trim()}
                    className="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition"
                  >
        ...
        {returnDetails && (
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-zinc-800/50 shadow-sm dark:shadow-zinc-900/50 rounded-lg p-6 border border-gray-200 dark:border-zinc-700/50">
              ...
              <div className="space-y-3">
                {returnDetails.items.map((item) => (
                  <div
                    key={item.id}
                    className="flex items-center justify-between p-3 bg-gray-50 dark:bg-zinc-900/50 rounded-lg border border-gray-200 dark:border-zinc-700"
                  >
                    <div>
                      <p className="font-medium text-gray-900 dark:text-gray-100">
            ...
            <div className="bg-white dark:bg-zinc-800/50 shadow-sm dark:shadow-zinc-900/50 rounded-lg p-6 border border-gray-200 dark:border-zinc-700/50">
              ...
              <div>
                ...
                <input
                  ...
                  className="block w-full rounded-md border border-gray-300 dark:border-zinc-600 bg-white dark:bg-zinc-900 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 p-2"
                />
            ...
            <div className="bg-white dark:bg-zinc-800/50 shadow-sm dark:shadow-zinc-900/50 rounded-lg p-6 border border-gray-200 dark:border-zinc-700/50">
              {error && (
                <div className="mb-4 rounded-md bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900/50 p-4">
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="flex-1 px-4 py-3 border border-gray-300 dark:border-zinc-600 rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-zinc-900 hover:bg-gray-50 dark:hover:bg-zinc-800 font-medium transition"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={receiving}
                  className="flex-1 px-4 py-3 bg-green-600 text-white rounded-md hover:bg-green-700 dark:bg-green-600 dark:hover:bg-green-700 disabled:opacity-50 font-medium transition"
                >
                  {receiving
                    ? "Receiving..."
