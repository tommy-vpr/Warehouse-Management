...
type UpdateShopifyFulfillmentArgs = {
  ...
  trackingUrl?: string;
  lineItems: Array<{
    variantId?: string; // Shopify variant GID if available
    sku?: string; // fallback
    quantity: number;
  }>;
  notifyCustomer?: boolean;
  isBackOrder?: boolean; // ✅ NEW: Track if this is a back order shipment
};
...
// ✅ NEW: Helper to get carrier name for Shopify
